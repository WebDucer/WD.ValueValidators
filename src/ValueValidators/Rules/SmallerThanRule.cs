...
namespace WD.ValueValidators.Rules
{
    ...
    public class SmallerThanRule<T> : IValidationRule<T> where T : struct, IComparable
    {
        ...
        public SmallerThanRule(string errorMessage, ValidatableValue<T> compareValue, bool equalIsValid = false)
        {
